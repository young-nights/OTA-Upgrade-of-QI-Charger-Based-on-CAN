...
**size 计算**：固件文件字节数（不含 256 字节 header），以大端序填入。示例：40KB 固件 = 0x0000A000。
...
|------|-----|
| 发送 ID | `0x18DA0D03` |
| 数据 | `03 22 F1 95 00 00 00 00` |
| 解析 | `03`=SF长度3, `22`=ReadDataByIdentifier, `F195`=ECU Software Version |
| 预期正响应 | `xx 62 F1 95 [版本字符串...]` |
